...
{
    public class AppUserUpdateValidator : AbstractValidator<AppUserAccountVM>
    {
        public AppUserUpdateValidator()
        {
            ...
            RuleFor(x => x.Address).NotEmpty().WithMessage("Please enter your username !");
            ...
            RuleFor(x => x.Address).MaximumLength(200).WithMessage("Address is up to 200 characters must be entered !");
